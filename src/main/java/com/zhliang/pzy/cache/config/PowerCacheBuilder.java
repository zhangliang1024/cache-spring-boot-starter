...
import com.zhliang.pzy.cache.service.CacheProviderService;
...
public class PowerCacheBuilder {
    ...
    private List<CacheProviderService> getCacheProviders() {
        ...
        try {
            ...
            isUseCache = configProp.getConfigVal(AppField.IS_USE_REDIS_CACHE);

            //启用Redis缓存
            if (AppConst.IS_USE_REDIS_CACHE.equalsIgnoreCase(isUseCache)) {
    ...
    public String getCacheVersion() {
        ...
        version = redisCacheService.get(configProp.getCacheVersionKey());
    ...
    public String resetCacheVersion() {
        ...
        redisCacheService.set(configProp.getCacheVersionKey(), version);
    ...
    public String generateVerKey(String key) {
        ...
        String version = redisCacheService.get(configProp.getCacheVersionKey());
    ...
    private boolean checkUseRedisCache() {
        String strIsUseCache = configProp.getConfigVal(AppField.IS_USE_REDIS_CACHE);
        return AppConst.IS_USE_REDIS_CACHE.equalsIgnoreCase(strIsUseCache);
    }

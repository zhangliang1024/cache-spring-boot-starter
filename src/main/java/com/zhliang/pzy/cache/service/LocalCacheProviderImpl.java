package com.zhliang.pzy.cache.service;

import com.google.common.cache.Cache;
import com.google.common.cache.CacheBuilder;
import com.google.common.collect.Maps;
import com.zhliang.pzy.cache.config.ConfigProp;
...
/**
 * @类描述：本地缓存提供者服务 (Guava Cache)
 * @创建时间：2020/10/16 11:34
 * @version：V1.0
// */
@Configuration
    ...
    private Cache<String, Object> getCacheContainer(Long expireTime) {
        ...
        try {
            ...
            cacheContainer = CacheBuilder.newBuilder()
                    .maximumSize(configProp.getCacheMaximumSize())
